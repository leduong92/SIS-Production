#Install
	1. Microsoft.AspNetCore.Mvc.Razor.RuntimeCompolation
	2. Micfosoft.IdentityModel.Login
	3. Microsoft.IdentityModel.Tokens
	4. Microsoft.VisualStudio.Web.CodeGeneration.Design
	4. System.IdentityModel.Tokens.Jwt
##Paging by ViewComponent
	1. Add controller inherit ViewComponent
	...
	2. Add component view
	    @model SIS_Production.ViewModels.Common.PagedResultBase
        @{
    ...
    3. Invoke to footer
### Tach ra BaseController de chung thuc token
